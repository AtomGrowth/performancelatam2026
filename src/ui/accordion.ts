...
export interface AccordionOptions {
  // Abrir el primero evita una columna de solo títulos cuando el accordion convive con un bloque alto.
  openFirst?: boolean;
  // Prefijo de ids: dos accordions en la misma página no pueden compartir aria-controls.
  idPrefix?: string;
}

export function renderAccordion(items: FaqItem[], opts: AccordionOptions = {}): HTMLElement {
  const { openFirst = false, idPrefix = 'aa-faq' } = opts;
